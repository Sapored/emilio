<head>
    ...
    <link rel="stylesheet" href="/styles-kioscos-headers.css">
    ...
    <title>Xilion | Kioscos de Recursos Humanos</title>
...
<body>
    ...
    <div class="kioscos-first">
        <div class="kk-header">
            <p class="title">Acerca de <span>Orígenes de Xilion</span></p>
            <p class="text">Los éxitos y fracasos de una empresa que intenta mejorar como las personas usan la
                tecnología.</p>
            ...
            <div class="bulb_chip ai-center">
                <img src="../../assets-landings/assets-kioscos/kas/idea.svg" alt="">
    ...
    <section class="origin">
        <div class="imgcontainer">
            <img src="../../assets-landings/assets-nosotros/image307.png" alt="">
        </div>
        <div class="textcontainer">
            <div class="list">
                <h3>1. Los Primeros Kioscos</h3>
                <p>Desde el 2000, hemos tenido un exitoso comienzo en México vendiendo kioscos y cajeros electrónicos.
                    Nos hemos expandido al área de smart city, ofreciendo soluciones innovadoras de movilidad, rastreo y
                    software para diversos negocios. Nuestro enfoque se basa en el desarrollo de aplicaciones y páginas
                    web personalizadas para nuestros clientes</p>
                <p class="textholder">Desde los inicios nuestra misión ha sido impulsar la innovación mientras desarrollamos talento de
                    clase mundial.</p>
                <p class="movil">Desde el 2000, hemos tenido un exitoso comienzo en México vendiendo kioscos y cajeros
                    electrónicos. Nos hemos expandido al área de smart city, ofreciendo soluciones innovadoras de movilidad, rastreo y
                    software para diversos negocios.</p>
            </div>
            <div class="list">
                <h3>2. Sin Visión y En Pandemia</h3>
                <p>En 2018, nos dimos cuenta de que estábamos estancados y complacidos con nuestros éxitos pasados.
                    Decidimos pivotar y reenfocarnos en la creación de productos excelentes e invertir en nuestro
                    futuro. Este cambio nos permitió revitalizar nuestra empresa, superar nuestros límites anteriores y
                    buscar constantemente la excelencia en todo lo que hacemos.</p>
                <p class="textholder">Nuestra visión es ser la referencia mundial para talento.</p>
                <p class="movil">En 2018, nos dimos cuenta de que estábamos estancados y complacidos con nuestros éxitos pasados.
                    Decidimos pivotar y reenfocarnos en la creación de productos excelentes e invertir en nuestro
                    futuro.</p>
            </div>
            <div class="list">
                <h3>3. El futuro es contigo </h3>
                <p>Ahora Xilion es una plataforma que procesa millones de transacciones en Latinoamérica con múltiples
                    servicios, reconocida por posicionar a nuestros clientes a través de la mejora del time-to-business,
                    reduciendo los costos de sus procesos y eficientando al máximo sus recursos.</p>
                <p class="movil">Ahora Xilion es una plataforma que procesa millones de transacciones en Latinoamérica con múltiples
                    servicios, reconocida por posicionar a nuestros clientes a través de la mejora del time-to-business,
                    reduciendo los costos de sus procesos y eficientando al máximo sus recursos.</p>
            </div>
        </div>
    ...
    <section class="exp flex-c container">
        <h1>¿Por qué elegir Xilion?</h1>
        <h2>Hay más razones pero te daremos tres.</h2>
        <div class="circlesinfo flex-c">
            <div class="circle flex-c" style="max-width: 25rem">
                <img src="/assets-landings/assets-nosotros/multiplataforma.png" alt="Personalizables">
                <h3>Software de Calidad</h3>
                <p>Nos adaptamos a tu plataforma de preferencia; Android, iOS, Windows, etc.</p>
            </div>
            <div class="circle flex-c" style="max-width: 25rem">
                <img src="/assets-landings/assets-nosotros/medida.png" alt="Personalizables">
                <h3>Precios a TU medida</h3>
                <p>Paga sólo por lo que necesitas, y obtén mucho más con nosotros</p>
            </div>
            <div class="circle flex-c" style="max-width: 25rem">
                <img src="/assets-landings/assets-nosotros/usuario.png" alt="Personalizables">
                <h3>Enfoque en el usuario</h3>
                <p>Nos llegan mejoras de nuestros clientes todos los días.</p>
            </div>
        </div>
    </section>
    <div class="exito container">
        <h1>Éxito en números</h1>
        <h2>Éstas son las estadísticas que nos permiten respaldar nuestra calidad y seguir dando el mejor servicio a
            nuestros clientes</h2>
        <div class="exito-container">
            <div class="exito-box">
                <img src="/assets-landings/assets-nosotros/exito1.svg" alt="icon">
                <div class="exito-title">2,000,000+</div>
                <div class="exito-p">Personas utilizan nuestros servicios</div>
            </div>
            <div class="exito-box">
                <img src="/assets-landings/assets-nosotros/exito2.svg" alt="icon">
                <div class="exito-title">300+</div>
                <div class="exito-p">Empresas satisfechas alrededor del mundo</div>
            </div>
            <div class="exito-box">
                <img src="/assets-landings/assets-nosotros/exito3.svg" alt="icon">
                <div class="exito-title">40+</div>
                <div class="exito-p">Millones de transacciones procesadas al año</div>
            </div>
            <div class="exito-box">
                <img src="/assets-landings/assets-nosotros/exito4.svg" alt="icon">
                <div class="exito-title">25+</div>
                <div class="exito-p">Más de 20 años de experiencia en el mercado</div>
            </div>
        </div>
    </div>
