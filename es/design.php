<head>
    ...
    <style>
        .blue {
            ...
            background: var(--yimi-day-bg-dark-brand, #04153C);
            display: flex;
...
<body>
    ...
    <div class="kioscos-first">
        <div class="kk-header">
            ...
            <p class="text">Diseños ilimitados por un precio accesible. </p>
            <div class="d-flex jc-center" style="gap: 3rem; width: 100%; flex-wrap: wrap;">
                <div class="d-flex leaf-block ai-center">
                    ...
                    <div class="d-flex fd-column ai-center">
                        <p class="freeTrail">Prueba Gratis</p>
                        <p>Durante 7 días</p>
                    </div>
