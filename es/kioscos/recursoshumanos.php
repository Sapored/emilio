...
<body>
    ...
    <div class="kioscos-first">
        <div class="kk-header RH">
            <p class="title txAl-s">Kioscos Digitales para <span>Recursos Humanos</span></p>
            <p class="text txAl-s">Optimiza tus procesos de recursos humanos con nuestros kioscos digitales. Acceso
                autónomo a información y servicios para empleados. Ahorra tiempo y simplifica tus operaciones
                empresariales.</p>
                    ...
                    <div>
                        <div class="kiosk-features">
                            <div class="kfeat-block">
                                ...
                                <p>Solicitudes de Permisos, Vacaciones y Viáticos</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/certificado.svg" alt="">
                                </div>
                                <p>Capacitaciones y Préstamos</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/nomina.svg" alt="">
                                </div>
                                <p>Consulta de Recibos de Nómina</p>
                            </div>
                        </div>
                        <div class="kiosk-features">
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/expediente.svg" alt="">
                                </div>
                                <p>Expediente Laboral y Sueldo Diario</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/registro.svg" alt="">
                                </div>
                                <p>Registro Vacaciones y Ausencias</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/comunicado.svg" alt="">
                                </div>
                                <p>Comunicados y Entrega de Información</p>
                            </div>
                        </div>
                    </div>
                </div>
