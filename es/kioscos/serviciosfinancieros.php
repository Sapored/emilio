...
<body>
    ...
    <div class="kioscos-first">
        <div class="kk-header RH">
            <p class="title txAl-s">Kioscos Digitales para <span>Servicios Financieros</span> y Seguros</p>
            <p class="text txAl-s">Simplifica tus trámites financieros con nuestros kioscos digitales. Accede a
                servicios bancarios de forma fácil y segura. Optimiza tu experiencia con la banca electrónica.</p>
                    ...
                    <div>
                        ...
                        <div class="kiosk-features">
                            <div class="kfeat-block">
                                ...
                                <p>Transferencias interbancarias e impresión de comprobantes</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/pantalla.svg" alt="">
                                </div>
                                <p>Tasas de interés y productos financieros</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/lealtad.svg" alt="">
                                </div>
                                <p>Asistencia y soporte técnico</p>
                            </div>
                        </div>
                    </div>
                </div>
