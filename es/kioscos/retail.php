...
<body>
    ...
    <div class="kioscos-first">
        <div class="kk-header RH">
            <p class="title txAl-s">Kioscos Digitales para <span>Retail</span> y Puntos de venta</p>
            <p class="text txAl-s">Optimiza tus procesos universitarios con nuestros kioscos de consulta. Accede a
                información y servicios académicos, administrativos y de recursos humanos de forma autónoma. Ahorra
                tiempo y agiliza tus trámites con nuestra solución práctica y rápida.</p>
                        ...
                        <div class="kiosk-features">
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/catalogo.svg" alt="">
                                </div>
                                <p>Consulta de catálogos y servicios</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/pedido.svg" alt="">
                                </div>
                                <p>Generación de pedidos en línea</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/credito.svg" alt="">
                                </div>
                                <p>Pagos con tarjetas de crédito o débito</p>
                            </div>
                        </div>
                        <div class="kiosk-features">
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/efectivo.svg" alt="">
                                </div>
                                <p>Pagos en efectivo</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/pantalla.svg" alt="">
                                </div>
                                <p>Pantalla publicitaria y señalización digital</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/lealtad.svg" alt="">
                                </div>
                                <p>Programa de lealtad y recompensas</p>
                            </div>
                        </div>
                    </div>
                </div>
