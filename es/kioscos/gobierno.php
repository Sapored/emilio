...
<body>
    ...
    <div class="kioscos-first">
        <div class="kk-header RH">
            <p class="title txAl-s">Kioscos Digitales para <span>Gobierno</span> y Servicios Públicos</p>
            <p class="text txAl-s">Simplifica tus trámites con nuestros kioscos digitales estratégicamente ubicados.
                Agiliza procesos burocráticos y documentación con nuestra tecnología innovadora. Amplia variedad de
                servicios para la ciudadanía.</p>
            <div class="footer-contact flex-c RH" id="web">
                <form action="/es/contacto.php">
                    <input class="footer-input" id="correo" type="email" placeholder="Correo electrónico" required>
                    <button href="/es/contacto.php" class="footer-button" type="input" onclick="llevar();">Cotiza tu
                        proyecto</button>
                </form>
            </div>
            <div class="footer-contact flex-c" id="app">
                <form action="/es/contacto.php">
                    <input class="footer-input" id="correo" type="email" placeholder="Correo electrónico" required>
                    <button href="/es/contacto.php" class="footer-button" type="input" onclick="llevar();">Cotiza tu
                        proyecto</button>
            ...
            <div class="d-flex goals" style="gap: 3rem; width: 100%; flex-wrap: wrap; margin-top: 6rem;">
            ...
            <div class="backgroundImgRH-responsive">
                <img src="../../assets-landings/assets-kioscos/kas/X-24.svg" alt="">
            </div>
        </div>
    </div>
    <div class="backgroundImgRH">
        <img src="../../assets-landings/assets-kioscos/kas/X-24.svg" alt="">
    </div>
    </div>
    <section style="display:flex; flex-direction: column; padding: 4rem 2rem; gap: 4rem;">
        <div class="d-flex movil-h" style="gap: 3rem; width: 100%; flex-wrap: wrap; margin-top: 6rem;">
            <div class="d-flex leaf-block ai-center">
                <img src="../../assets-landings/assets-kioscos/leaf_left.svg" alt="">
                <div class="d-flex fd-column ai-center">
                    <p>+6,500</p>
        ...
        <div class="bulb_chip d-flex ai-center movil-h">
            <img src="../../assets-landings/assets-kioscos/kas/idea.svg" alt="">
            <p>Mejor Fabricación, Precio y Software del Mercado</p>
        </div>
    </section>
                        ...
                        <div class="kiosk-features">
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/love.svg" alt="">
                                </div>
                                <p>Registro Civil</p>
                                <p class="alt">Certificados de Nacimiento, Matrimonio</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/wallet.svg" alt="">
                                </div>
                                <p>Servicios Municipales</p>
                                <p class="alt">Impuestos Predial, Licencias</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/potable.svg" alt="">
                                </div>
                                <p>Agua Potable</p>
                                <p class="alt">Consulta de Saldos, Pagos</p>
                            </div>
                        </div>
                        <div class="kiosk-features">
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/car.svg" alt="">
                                </div>
                                <p>Trámites Vehiculares</p>
                                <p class="alt">Refrendo Vehicular, Infracciones</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/sello.svg" alt="">
                                </div>
                                <p>Notarios</p>
                                <p class="alt">Servicios de Asesoría Legal</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/paper.svg" alt="">
                                </div>
                                <p>Otros Servicios</p>
                                <p class="alt">Emplacamiento, Antecedentes Penales</p>
                            </div>
                        </div>
                    </div>
                </div>
