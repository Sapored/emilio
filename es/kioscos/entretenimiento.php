...
<body>
    ...
    <div class="kioscos-first">
        <div class="kk-header RH">
            <p class="title txAl-s">Kioscos Digitales para <span>Entretenimiento</span> y Gestión de Contenido</p>
            <p class="text txAl-s">Crea y gestiona tu red de contenidos con nuestros kioscos digitales. Reproduce videos
                e imágenes publicitarias de forma versátil y dinámica. Potencia tu estrategia de marketing en línea.</p>
                        ...
                        <div class="kiosk-features">
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/concierge.svg" alt="">
                                </div>
                                <p>Concierge digital</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/eventos.svg" alt="">
                                </div>
                                <p>Publicidad e información para eventos especiales</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/menu.svg" alt="">
                                </div>
                                <p>Menús interactivos en pantalla y promociones</p>
                            </div>
                        </div>
                        <div class="kiosk-features">
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/reproduccion.svg" alt="">
                                </div>
                                <p>Reproducción de publicidad en varias ubicaciones</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/directorio.svg" alt="">
                                </div>
                                <p>Directorios de negocios</p>
                            </div>
                            <div class="kfeat-block">
                                <div class="border-block">
                                    <img src="../../assets-landings/assets-kioscos/kas/mapa.svg" alt="">
                                </div>
